        ...
        <SafeAreaView style={[style.area, { backgroundColor: Colors.bg }]}>
            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior={'padding'}>
                <View style={[style.main, { backgroundColor: Colors.bg, }]}>
                    ...
                    <Text style={[style.title, { color: Colors.active, marginTop: 20 }]}>Verification Code</Text>
                    <Text style={[style.r14, { color: Colors.disable, marginTop: 10 }]}>Enter the verification code that we have sent to your phone number</Text>
